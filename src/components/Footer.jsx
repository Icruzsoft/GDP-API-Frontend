  ...
  return (
    <footer className="bg-gray-800 text-white py-4 px-4 grid grid-cols-2 items-center gap-4 absolute bottom-0 w-full">
      <div className="flex items-center gap-4">
        ...
        <a href="#" className="hover:opacity-75">Aviso de Privacidad</a>
      </div>
      <div className="flex items-center justify-end gap-4"> <a href="#" className="rounded-full hover:opacity-75 shadow-md">
