        ...
        <div className="container mx-auto flex flex-wrap ml-64">
                <div className="w-full md:w-1/4 p-4">
                    <div className="bg-white border rounded-md shadow-md p-4">
                        ...
                        <form action="">
                            <h2 className="text-xl font-bold mb-2 text-gray-950 ml-52 bot">112</h2>
                        </form>
                ...
                <div className="w-full md:w-1/4 p-4">
                    <div className="bg-white border rounded-md shadow-md p-4">
                        ...
                        <form action="">
                            <h2 className="text-xl font-bold mb-2 text-gray-950 ml-52">218</h2>
                        </form>
                        ...
                        <div className='bg-white border rounded-md p-4'>
                            ...
                            <div className="bg-white border rounded-md shadow-md p-4">
                                <form className='flex justify-between'>
                                    <h2 className="text-xl font-bold mb-2 text-gray-950">Hoy Salir</h2>
                            ...
                            <div className="bg-white border rounded-md shadow-md p-4">
                                <form className='flex justify-between'>
                                    <h2 className="text-xl font-bold mb-2 text-gray-950">Factura Pendiente</h2>
                                    <h2 className="text-xl font-bold mb-2 text-gray-950">15/92</h2>
                                </form>
                            </div>
                            <div className="bg-white border rounded-md shadow-md p-4">
                                <form className='flex justify-between'>
                                    <h2 className="text-xl font-bold mb-2 text-gray-950">Proyectos Completados</h2>
                                    <h2 className="text-xl font-bold mb-2 text-gray-950">85/112</h2>
                                </form>
                            </div>
                            <div className="bg-white border rounded-md shadow-md p-4">
                                <form className='flex justify-between'>
                                    <h2 className="text-xl font-bold mb-2 text-gray-950">Entrada Abiertas</h2>
                                    <h2 className="text-xl font-bold mb-2 text-gray-950">190/212</h2>
                                </form>
                            </div>
                            <div className="bg-white border rounded-md shadow-md p-4">
                                <form className='flex justify-between'>
                                    <h2 className="text-xl font-bold mb-2 text-gray-950">Entradas Cerradas</h2>
            ...
            <div className='container mx-auto flex flex-wrap ml-64'>   
                <div className='w-full md:w-1/2 p-4'>         
                    <div className='bg-white border rounded-md p-4'>
                            <h2 className="text-xl font-bold mb-2 text-gray-950">Estadísticas de Tareas</h2>
                        <form className='flex justify-between'>
                            <div className="w-full md:w-1/2 p-4">
                                <div className="bg-white border rounded-md shadow-md p-4">
                                    <form action="">
                                        <h2 className="text-xl font-bold mb-2 text-gray-950">Tareas Totales</h2>
                                    </form>
                            ...
                            <div className="w-full md:w-1/2 p-4">
                                <div className="bg-white border rounded-md shadow-md p-4">
                                    <form action="">
                                        <h2 className="text-xl font-bold mb-2 text-gray-950">Tareas Atrasadas</h2>
                                    </form>
